...
| Phase | Focus | Status |
|-------|-------|--------|
| **Now** | Entry format, 10–20 quality entries, basic loaders, test suite, multi-agent workflow | In progress |
| **Short-term** | PyPI package, more entries, framework integrations (LangGraph, CrewAI, etc.) | Planned |
